...
nyc <- read.csv("https://raw.githubusercontent.com/fredlapolla/RScience2021_libr/master/NYC_HANES_DIAB.csv")
...
## Exercise: Reclassify DX_DBTS, a variable that holds three groups, 1) Diabetes with a diagnosis; 2) Diabetes with no diagnosis and 3) No Diabetes. 
...
## Exercise: What type of structure is nyc?
...
## Exercise: Create a visualization to assess the skew of LEAD and of HDL levels. 
...
## EXERCISE: Create a subset of the nyc_hanes dataset that has data only for the oldest group of diabetics that have a total cholesterol over 200. How many observations are in the resulting dataset?
